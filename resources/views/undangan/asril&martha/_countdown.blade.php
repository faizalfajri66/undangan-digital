<div class="relative bg-gradient-to-r from-[#1a1a1a] via-[#231f20] to-[#1a1a1a] text-white py-10 px-4 md:px-8 text-center shadow-lg mt-0 overflow-hidden font-custom">
    ...
    <div class="flex justify-center mb-6"
        ...
        <img src="{{ asset('assets/asril3.jpg') }}" alt="Count_Down"
