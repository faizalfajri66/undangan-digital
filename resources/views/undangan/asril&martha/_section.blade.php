<div class="relative w-full text-center py-24 bg-cover bg-center shadow-2xl overflow-hidden"
     style="background-image: url('{{ asset('assets/background_black_02.jpg') }}');">
    ...
    <div class="relative z-10 px-4 md:px-6 max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="400">
        ...
        <!-- Subjudul Bismillah -->
        <h2 class="text-white text-3xl md:text-4xl drop-shadow-md tracking-wide"
        ...
        <!-- Nama tamu -->
        @if ($namaTamu)
            <p class="text-white text-lg md:text-xl mt-10 italic drop-shadow-sm"
        ...
        <!-- Kalimat undangan -->
        <p class="text-white mt-6 text-sm md:text-base leading-relaxed max-w-2xl mx-auto font-light"
