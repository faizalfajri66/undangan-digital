<div class="py-20 px-4 bg-[#e6f7ff] text-center">
    <h2 class="text-3xl font-semibold text-[#2980b9] mb-6">Donation</h2>
    ...
    @if(!empty($undangan->rekening_nama) && !empty($undangan->rekening_nomor))
        <div class="max-w-md mx-auto bg-white rounded-2xl shadow-lg overflow-hidden p-6 md:p-8 border border-blue-200 relative">
            ...
            <div class="text-left space-y-4">
                ...
                <div class="text-xl md:text-2xl font-mono tracking-wider text-[#2980b9]">
            ...
            <!-- Hiasan chip -->
            <div class="absolute top-4 right-4 w-10 h-7 bg-yellow-400 rounded-sm"></div>
        </div>
    @else
