<div class="relative bg-cover bg-center py-20 px-4 text-center" style="background-image: url('{{ asset('assets/backgroun_2.png') }}');">
    ...
    <div class="relative z-10 max-w-5xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row-reverse items-center justify-center md:gap-20 gap-12">
            <!-- Mempelai Wanita -->
            <div class="flex flex-col items-center max-w-xs text-gray-800 transition-transform hover:scale-105 duration-300">
                <div class="w-36 h-36 md:w-44 md:h-44 rounded-full overflow-hidden shadow-xl ring-4 ring-pink-400">
                    <img src="{{ asset('assets/calon_wanita2.jpg') }}" alt="Mempelai Wanita" class="object-cover w-full h-full" />
                </div>
            ...
            <div class="flex flex-col items-center max-w-xs text-gray-800 transition-transform hover:scale-105 duration-300">
                <div class="w-36 h-36 md:w-44 md:h-44 rounded-full overflow-hidden shadow-xl ring-4 ring-blue-400">
                    <img src="{{ asset('assets/calon_pria2.jpg') }}" alt="Mempelai Pria" class="object-cover w-full h-full" />
                </div>
                <p class="mt-4 text-lg md:text-xl font-bold text-center">{{ $undangan->nama_pria }}</p>
                <p class="mt-1 text-sm md:text-base italic text-center leading-snug">
