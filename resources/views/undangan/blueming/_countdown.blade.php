<div class="relative bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 text-white py-10 px-4 md:px-8 text-center rounded-b-lg shadow-lg mt-0 overflow-hidden">
    <!-- Judul -->
    ...
    <div class="flex justify-center mb-6 animate__animated animate__zoomIn animate__delay-1s">
        <img src="{{ asset('assets/count_down2.png') }}" alt="Count_Down" class="w-32 h-32 md:w-40 md:h-40 rounded-full shadow-lg ring-4 ring-white object-cover" />
    </div>
