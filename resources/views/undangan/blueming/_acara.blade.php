<div 
    ...
    style="background-image: url('{{ asset('assets/backgroun.png') }}'); background-size: cover; background-position: center;"
>
    <div class="max-w-4xl mx-auto">
        <h2 class="text-2xl md:text-3xl font-semibold text-blue-800 mb-12 tracking-wide">Rangkaian Acara</h2>
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-10 bg-white/70 rounded-xl p-6 shadow-md backdrop-blur-md">
            ...
            <div class="flex flex-col items-center text-gray-800">
                ...
                <div class="text-6xl md:text-7xl font-extrabold text-blue-600 leading-none">
            ...
            <div class="text-center md:text-left space-y-4 text-gray-700">
                <div class="text-lg md:text-xl font-semibold">
                    Pukul: <span class="text-blue-600">{{ \Carbon\Carbon::parse($undangan->tanggal_acara)->format('H:i') }} WIB</span>
                </div>
                <div class="text-base md:text-lg font-medium leading-relaxed">
                    Tempat: <br>
                    <span class="text-blue-600">{{ $undangan->lokasi }}</span>
                </div>
                ...
                <div class="mt-6">
                    <a
                        ...
                        target="_blank"
                        class="inline-block px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition"
                    >
                        Simpan ke Kalender
                    </a>
                </div>
...
@if($undangan->link_maps)
    <div class="mt-12">
        <div class="bg-white/70 backdrop-blur-md shadow-lg ring-2 ring-blue-300 rounded-xl max-w-3xl mx-auto p-6">
