@if($undangan->quote)
    <div class="text-center my-20 px-6">
        <blockquote class="text-xl md:text-2xl italic text-gray-800 border-l-4 border-blue-500 pl-6 py-6 mx-auto max-w-3xl bg-white/70 backdrop-blur-sm rounded-xl shadow-sm">
            “{{ $undangan->quote }}”
        </blockquote>
